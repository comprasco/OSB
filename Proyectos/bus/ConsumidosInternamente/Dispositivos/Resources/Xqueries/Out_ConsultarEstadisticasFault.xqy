...
declare function local:func($codigo as xs:string, $mensaje as xs:string) as element() (:: schema-element(ns1:consultarEstadisticasResponse) ::) {
    <ns1:consultarEstadisticasResponse>
        <salidaEstadisticas>
