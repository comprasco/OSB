...
declare namespace ns1="https://www.supernotariado.gov.co/schemas/bachue/ci/consultacatalogos/consultarcatalogos/v1";
...
declare function local:func($codigoMensaje as xs:string, $descripcionMensaje as xs:string) as element() (:: schema-element(ns1:salidaConsultarCatalogos) ::) {
    <ns1:salidaConsultarCatalogos>
