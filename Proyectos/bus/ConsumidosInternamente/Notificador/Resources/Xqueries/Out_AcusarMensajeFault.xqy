...
declare namespace ns1="https://www.supernotariado.gov.co/schemas/bachue/cb/notificador/acusarmensaje/v1";
(:: import schema at "../Schemas/Legacy/CB_NB_AcusarMensaje.xsd" ::)

declare variable $codigoMensaje as xs:string external;
declare variable $descripcionMensaje as xs:string external;
declare function local:func($codigoMensaje as xs:string, $descripcionMensaje as xs:string) as element() (:: schema-element(ns1:salidaAcusarMensaje) ::) {
    <ns1:salidaAcusarMensaje>
