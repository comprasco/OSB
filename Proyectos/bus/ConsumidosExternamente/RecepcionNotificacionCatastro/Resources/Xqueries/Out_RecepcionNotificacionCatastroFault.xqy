...
declare namespace ns1="https://www.supernotariado.gov.co/schemas/bachue/ce/recepcionNotificacionCatastro/notificarCambioCatastro/v1";
(:: import schema at "../Schemas/Legacy/CE_CC_NotificarCambioCatastro.xsd" ::)
declare variable $codigoMensaje as xs:string external;
declare variable $descripcionMensaje as xs:string external;


declare function local:func($codigoMensaje as xs:string, $descripcionMensaje as xs:string) as element() (:: schema-element(ns1:salidaNotificarCambioCatastro) ::) {
    <ns1:salidaNotificarCambioCatastro>
