...
declare namespace ns2="https://www.supernotariado.gov.co/schemas/bachue/cb/operacionesfinancieras/registrarpago/v2";
(:: import schema at "../Schemas/Legacy/CB_OF_RegistrarPago.xsd" ::)
...
declare function local:func($payloadRequest as element() (:: schema-element(ns1:entradaNotificarPago) ::)) as element() (:: schema-element(ns2:entradaRegistrarPago) ::) {
    <ns2:entradaRegistrarPago>
