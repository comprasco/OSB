...
declare function local:func($payloadRequest as element() (:: schema-element(ns1:consultaEstadoJuridicaSolicitud) ::)) as element() (:: schema-element(ns2:entradaDatosPropietario) ::) {
