...
declare namespace ns1="https://www.supernotariado.gov.co/services/bachue/cb/matriculasrelacionadas/consultarMatriculasDerivadas/v1";
(:: import schema at "../Schemas/Legacy/CB_MR_consultarMatriculasDerivadas.xsd" ::)

declare variable $payloadRequest as element() (:: schema-element(ns1:salidaDatosMatriculasDerivadas) ::) external;

declare function local:func($payloadRequest as element() (:: schema-element(ns1:salidaDatosMatriculasDerivadas) ::)) as element() (:: schema-element(ns2:consultaEstadoJuridicoRespuesta) ::) {
