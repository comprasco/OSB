...
declare namespace ns1="https://www.supernotariado.gov.co/services/bachue/cb/matriculasrelacionadas/consultarMatriculasMatriz/v1";
(:: import schema at "../Schemas/Legacy/CB_MR_consultarMatriculasMatriz.xsd" ::)

declare variable $payloadRequest as element() (:: schema-element(ns1:salidaDatosMatriculasMatriz) ::) external;

declare function local:func($payloadRequest as element() (:: schema-element(ns1:salidaDatosMatriculasMatriz) ::)) as element() (:: schema-element(ns2:consultaEstadoJuridicoRespuesta) ::) {
