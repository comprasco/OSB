...
declare variable $payloadRequest as element() (:: schema-element(ns1:salidaDatosPropietario) ::) external;

declare function local:func($payloadRequest as element() (:: schema-element(ns1:salidaDatosPropietario) ::)) as element() (:: schema-element(ns2:consultaEstadoJuridicoRespuesta) ::) {
