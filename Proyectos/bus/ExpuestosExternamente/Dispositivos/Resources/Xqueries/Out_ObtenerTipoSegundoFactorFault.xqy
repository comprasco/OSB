...
declare function local:func($codigo as xs:string, $mensaje as xs:string) as element() (:: schema-element(ns1:obtenerTipoSegundoFactorResponse) ::) {
    <ns1:obtenerTipoSegundoFactorResponse>
        <salidaResultado>
