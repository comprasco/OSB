...
declare variable $payloadResponse as element() (:: schema-element(ns1:salidaDatosMatriculasDerivadas) ::) external;

declare function local:func($payloadResponse as element() (:: schema-element(ns1:salidaDatosMatriculasDerivadas) ::)) as element() (:: schema-element(ns2:salidaConsultaCT) ::) {
