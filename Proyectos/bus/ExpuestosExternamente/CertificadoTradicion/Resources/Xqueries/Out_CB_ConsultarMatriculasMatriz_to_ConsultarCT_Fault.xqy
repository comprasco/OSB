...
declare variable $payloadResponse as element() (:: schema-element(ns1:salidaDatosMatriculasMatriz) ::) external;

declare function local:func($payloadResponse as element() (:: schema-element(ns1:salidaDatosMatriculasMatriz) ::)) as element() (:: schema-element(ns2:salidaConsultaCT) ::) {
