...
declare variable $payloadResponse as element() (:: schema-element(ns1:salidaObtenerProducto) ::) external;

declare function local:func($payloadResponse as element() (:: schema-element(ns1:salidaObtenerProducto) ::)) as element() (:: schema-element(ns2:salidaObtenerProducto) ::) {
