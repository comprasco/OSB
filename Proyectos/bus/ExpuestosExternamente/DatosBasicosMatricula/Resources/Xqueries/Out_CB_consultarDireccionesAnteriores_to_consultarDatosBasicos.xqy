...
declare function local:func($payloadResponse as element() (:: schema-element(ns1:salidaDireccionesAnteriores) ::)) as element() (:: schema-element(ns2:salidaDatosBasicos) ::) {
    <ns2:salidaDatosBasicos>
        ...
        <ns2:matriculas>
            ...
            <ns2:NUPRE></ns2:NUPRE>
            <ns2:direccionPredio>{fn:data($payloadResponse/ns1:direccionesPredioAnteriores/ns1:direccionPredio)}</ns2:direccionPredio>
