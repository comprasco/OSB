...
declare function local:func($payloadRequest as element() (:: schema-element(ns1:entradaDatosBasicos) ::)) as element() (:: schema-element(ns2:entradaDireccionesAnteriores) ::) {
    <ns2:entradaDireccionesAnteriores>
