        ...
        <entrada>
            ...
            <tipoLstCertificadoTradiciLibertEnt>
                ...
                <ubicacionMatriculaSistemaSNR>
                    <CHIPPredio>{fn:data($payloadRequest/ns1:valorCriterioBusqueda)}</CHIPPredio>
                    <cedulaCatastralPredio>{fn:data($payloadRequest/ns1:valorCriterioBusqueda)}</cedulaCatastralPredio>
