...
declare namespace ns1="https://www.supernotariado.gov.co/schemas/bachue/ee/cambioLinderosPredios/consultaSegregacionSinCambioPropietario/v1";
(:: import schema at "../Schemas/Legacy/EE_CC_ConsultaSegregacionSinCambioPropietario.xsd" ::)

declare variable $payloadResponse as element() (:: schema-element(ns1:salidaConsultaSegregacionSinCambioPropietario) ::) external;

declare function local:func($payloadResponse as element() (:: schema-element(ns1:salidaConsultaSegregacionSinCambioPropietario) ::)) as element() (:: schema-element(ns1:salidaConsultaSegregacionSinCambioPropietario) ::) {
    <ns1:salidaConsultaSegregacionSinCambioPropietario>
        {
